...
# norootforbuild
# usedforbuild    ConsoleKit PolicyKit aaa_base acl attr audit-libs autoconf automake bash binutils bzip2 coreutils cpio cpp cpp42 cracklib cvs cyrus-sasl dbus-1 dbus-1-devel dbus-1-glib dbus-1-glib-devel diffutils doxygen file filesystem fillup findutils flex gawk gcc gcc42 gdbm gettext gettext-devel glib2 glib2-devel glibc glibc-devel glibc-locale grep groff gzip hal hal-devel info insserv less libacl libattr libblkid-devel libblkid1 libbz2-1 libbz2-devel libcom_err-devel libcom_err2 libdb-4_5 libexpat1 libext2fs-devel libext2fs2 libgcc42 libgomp42 libltdl-3 libmudflap42 libnscd libopenssl0_9_8 libpng libreadline5 libsmbios-libs libstdc++42 libtool libusb libusb-devel libuuid-devel libuuid1 libvolume_id libxcrypt libzio linux-kernel-headers m4 make man mktemp ncurses net-tools netcfg openldap2-client openssl-certs pam pam-config pam-modules parted patch perl perl-XML-Parser perl-XML-Writer perl-base permissions pkg-config pmtools popt pwdutils rpm sed setserial sysvinit tar texinfo timezone udev util-linux xorg-x11-libX11 xorg-x11-libXau xorg-x11-libxcb zlib

Name:           hwinfo
BuildRequires:  doxygen flex hal-devel perl-XML-Parser perl-XML-Writer udev suse-macros
License:        GPL v2 or later
Group:          Hardware/Other
Provides:       libhd
Obsoletes:      libhd
Requires:       dbus >= 0.34 hal >= 0.5.2
...
Provides:       libhddev
Obsoletes:      libhddev
Requires:       %name = %version perl-XML-Writer perl-XML-Parser udev wireless-tools
...
* Tue Sep 04 2007 - snwint@suse.de
- some more dir -> link sysfs changes (#303978)
* Mon Sep 03 2007 - snwint@suse.de
...
* Thu Mar 08 2007 - snwint@suse.de
- updated X11 data
...
- fixed minor bug
- use RPM_OPT_FLAGS
* Mon Sep 04 2006 - snwint@suse.de
...
- Don't strip binaries.
* Mon May 08 2006 - snwint@suse.de
...
- updated X11 data
* Thu Mar 09 2006 - snwint@suse.de
...
* Wed Mar 08 2006 - snwint@suse.de
...
* Wed Feb 08 2006 - snwint@suse.de
...
* Mon Jan 09 2006 - snwint@suse.de
- adjusted i2o driver info (#129301)
* Mon Jan 09 2006 - snwint@suse.de
- jg: wlan update
* Fri Dec 09 2005 - snwint@suse.de
- add VirtualIron network cards (#135309)
- updated X11 data
* Wed Dec 07 2005 - snwint@suse.de
- report ide-generic for non-pci ide interfaces
* Tue Dec 06 2005 - snwint@suse.de
...
* Tue Sep 06 2005 - snwint@suse.de
...
* Thu Sep 01 2005 - snwint@suse.de
...
* Wed Jul 06 2005 - snwint@suse.de
- pci devs basically work
- use giant ibm notebook database
- added 'hwclass' entry to db format
* Tue Jul 05 2005 - snwint@suse.de
- make C++ happy
* Mon Jul 04 2005 - snwint@suse.de
...
* Thu Jun 09 2005 - snwint@suse.de
...
* Fri Apr 01 2005 - snwint@suse.de
- removed hwscan*
...
- updated X11 data
* Fri Mar 04 2005 - snwint@suse.de
...
* Thu Dec 02 2004 - snwint@suse.de
...
* Thu Oct 07 2004 - snwint@suse.de
...
* Thu Aug 05 2004 - snwint@suse.de
- push/pop don't work with 32bit regs on amd64 (#43531)
* Wed Aug 04 2004 - snwint@suse.de
- get netcard link state via ethtool ioctl
* Tue Jul 06 2004 - snwint@suse.de
...
* Thu May 06 2004 - snwint@suse.de
...
* Thu Apr 01 2004 - snwint@suse.de
...
- updated X11 data
* Thu Mar 04 2004 - snwint@suse.de
...
* Mon Feb 09 2004 - snwint@suse.de
...
* Tue Sep 09 2003 - snwint@suse.de
- more ltmodem ids
...
* Tue Sep 02 2003 - snwint@suse.de
...
* Fri Mar 07 2003 - snwint@suse.de
...
* Tue Mar 04 2003 - snwint@suse.de
...
* Thu Jan 09 2003 - snwint@suse.de
...
* Wed Nov 06 2002 - snwint@suse.de
...
* Fri Sep 06 2002 - snwint@suse.de
- new x11 data
...
- updated docs
* Fri Aug 09 2002 - snwint@suse.de
...
* Wed Aug 07 2002 - snwint@suse.de
- fixed segfault while probing for video
* Mon Aug 05 2002 - snwint@suse.de
- gmac -> sungem
...
- get bios led status
* Wed Jun 05 2002 - snwint@suse.de
...
* Fri Mar 01 2002 - snwint@suse.de
...
* Fri Feb 08 2002 - kkeil@suse.de
- isdn database now in libhd, support for multiple isdn driver
* Thu Feb 07 2002 - snwint@suse.de
...
* Fri Jan 04 2002 - snwint@suse.de
...
* Wed Dec 05 2001 - snwint@suse.de
...
* Mon May 07 2001 - snwint@suse.de
...
* Thu May 03 2001 - snwint@suse.de
- added vmware check
...
* Sat Apr 07 2001 - snwint@suse.de
...
* Fri Feb 09 2001 - snwint@suse.de
...
* Tue Jan 09 2001 - snwint@suse.de
...
* Sun Jan 07 2001 - snwint@suse.de
...
* Fri Dec 08 2000 - snwint@suse.de
- new alva detection code
- added cd-r/dvd detection
- read "el torito" boot info
* Thu Dec 07 2000 - snwint@suse.de
- fixed evil hddb bug
- added 3d script field
* Fri Dec 01 2000 - snwint@suse.de
- changed to new package name
* Thu Nov 09 2000 - snwint@suse.de
...
* Thu Sep 07 2000 - snwint@suse.de
- fixed modem segfault bug
- fixed Zip device detection
* Wed Sep 06 2000 - snwint@suse.de
- s390: network devices
* Tue Sep 05 2000 - snwint@suse.de
- s390: finds disks
...
* Wed Aug 09 2000 - snwint@suse.de
...
* Fri Jul 07 2000 - snwint@suse.de
- fixed hw_sys/hw_tv probing bug
* Thu Jul 06 2000 - snwint@suse.de
- new 'system' hw entry
- sparc smp detection: active -> probed
* Wed Jul 05 2000 - snwint@suse.de
- added parallel Zip drive detection
* Mon Jul 03 2000 - snwint@suse.de
...
* Thu Jun 08 2000 - snwint@suse.de
- added hd_list() function
* Tue Jun 06 2000 - snwint@suse.de
- new SaX[2] data
- changed mk_ids to provide 3d *and* non-3d x11 entries
* Mon Jun 05 2000 - snwint@suse.de
...
- new Mac color code
* Mon Apr 03 2000 - snwint@suse.de
- fixed XkbModel typo on intel/axp
...
- see ChangeLog
* Wed Mar 08 2000 - snwint@suse.de
- adapted for release
* Wed Mar 08 2000 - snwint@suse.de
- see ChangeLog
* Wed Mar 08 2000 - snwint@suse.de
...
* Wed Mar 08 2000 - snwint@suse.de
- see ChangeLog
* Mon Mar 06 2000 - snwint@suse.de
- see ChangeLog
* Sun Mar 05 2000 - snwint@suse.de
- some monitor data
* Sat Mar 04 2000 - snwint@suse.de
- see ChangeLog
* Fri Mar 03 2000 - snwint@suse.de
- small fixes
* Wed Mar 01 2000 - ro@suse.de
- fixed filelist
* Wed Mar 01 2000 - snwint@suse.de
- see ChangeLog
...
- see ChangeLog
* Sat Feb 05 2000 - snwint@suse.de
- see ChangeLog
* Tue Feb 01 2000 - snwint@suse.de
- see ChangeLog
